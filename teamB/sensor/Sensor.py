...
class SensorServer(Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            sn1 = ((c2 - 287) - (0.01 * c3 - (c3 - 292))) * 3.87596899
            ...
            sn2 = ((c4 - 418) - (0.08 * c5 - (c5 - 404))) * 2.54452926
            ...
            sn3 = ((c6 - 345) - (0.03 * c7 - (c7 - 314))) * 3.42465753 * 0.001
            ...
            sn4 =  ((c8 - 333) - (0.16 * c9 - (c9 - 274))) * 3.47222222
            ...
            pm25 = (0.518 + 0.00274 * (240.0 * (1000 * c10) ** 6 - 2491.3 * (1000 * c10) ** 5 + 9448.7 * (1000 * c10) ** 4 - 14840.0 * (
                1000 * c10) ** 3 + 10684.0 * (1000 * c10) ** 2 + 2211.8 * (1000 * c10) + 7.9623)) * 10 ** -32
