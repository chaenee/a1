...
if __name__ == '__main__':
    ...
    while True:
        ...
        temp = uniform(20, 35)  # random temperature
        SN1 = round(uniform(500, 1500), 2)  # random SN1 value
        SN2 = round(uniform(100, 300), 2)  # random SN2 value
        SN3 = round(uniform(10, 40), 2)  # random SN3 value
        SN4 = round(uniform(100, 600), 2)  # random SN4 value
        PM25 = round(uniform(100, 300), 2)
